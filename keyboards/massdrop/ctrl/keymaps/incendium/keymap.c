/**
 * QMK Firmware - Massdrop CTRL - Incendium Keymap
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_KL] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MO(_FL), LT_APP,  KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_NL] = LAYOUT(
    ...
    [_FL] = LAYOUT(
        ...
        _______, MAS_RED, MAS_YEL, MAS_GRN, MAS_BLU, MAS_CYN, MAS_PRP, MAS_MGT, MAS_CRM, MAS_WHT, MAS_KEY, RGB_RMOD,RGB_MOD, _______,   KC_MNXT, KC_MPLY, KC_VOLU,
        _______, RGB_MOD, RGB_SPI, RGB_HUI, RGB_SAI, RGB_VAI, _______, _______, _______, _______, _______, _______, _______, _______,   KC_MPRV, KC_MSTP, KC_VOLD,
        _______, RGB_RMOD,RGB_SPD, RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, _______, OS_LOCK, _______, _______, _______,
        _______, RGB_TOG, _______, _______, _______, MD_BOOT, NK_TOGG, _______, _______, _______, _______, _______,                              RGB_VAI,
    ...
    [_ML] = LAYOUT(
        ...
        _______, KC_BTN4, KC_BTN3, KC_BTN5, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_BTN4, KC_BTN3, KC_BTN5,
        _______, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_BTN1, _______, KC_BTN2,
        ...
        _______, _______, _______,                   _______,                            _______, _______, _LAYER_, _______,            KC_MS_L, KC_MS_D, KC_MS_R
    ),
    /*
    [DEFAULT] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,           KC_PSCR, KC_SLCK, KC_PAUS,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [_NL] = {
        ...
        WHITE,   AZURE,   AZURE,   AZURE,   TEAL,    _______, _______, GOLD,    GOLD,    GOLD,    GREEN,   GREEN,   GREEN,
        _______, _______, _______, _______, GREEN,   _______, RED,     RED,     RED,     GREEN,   GREEN,   _______,                              _______,
        _______, _______, _______,                   _______,                            _______, _______, _______, _______,            _______, _______, _______
    },
    [_FL] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            RED,     _______, _______,
        _______, RED,     YELLOW,  GREEN,   BLUE,    CYAN,    M9B59B5, MAGENT,  CREAM,   WHITE,   {1,0,8}, GOLD,    GOLD,    _______,   ORANGE,  GREEN,   AZURE,
        _______, GOLD,    CORAL,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   ORANGE,  RED,     AZURE,
        _______, GOLD,    CORAL,   _______, _______, _______, _______, _______, _______, RED,     _______, _______, _______,
        _______, RED,     _______, _______, _______, RED,     PINK,    _______, _______, _______, _______, _______,                              _______,
        _______, _______, _______,                   _______,                            _______, WHITE,   _______, _______,            CORAL,   _______, CORAL
    },
    [_ML] = {
        _______, AZURE,   AZURE,   AZURE,   _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______,
        _______, CYAN,    CYAN,    CYAN,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   CYAN,    CYAN,    CYAN,
        _______, CYAN,    AZURE,   CYAN,    TEAL,    _______, _______, _______, _______, _______, _______, _______, _______, _______,   CYAN,    _______, CYAN,
        _______, AZURE,   AZURE,   AZURE,   TEAL,    _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              AZURE,
        _______, _______, _______,                   _______,                            _______, _______, WHITE,   _______,            AZURE,   AZURE,   AZURE
    },
};
#    undef _______
